...
tr("inventory.putForSaleSuccess", "Item put up for sale!", "物品已上架!");
tr("inventory.putForSaleFailed", "Failed to put item for sale", "上架物品失败");
tr("inventory.stopSellingSuccess", "Item removed from sale!", "物品已停止出售!");
tr("inventory.stopSellingFailed", "Failed to stop selling", "停止出售失败");
tr("inventory.priceUpdated", "Price updated to {price} credits!", "价格已更新为 {price} 积分!");
tr("inventory.updatePriceFailed", "Failed to update price", "更新价格失败");
tr("inventory.usernameRequired", "Target username is required", "需要目标用户名");
tr("inventory.transferredTo", "Transferred to {user}!", "已转让给 {user}!");
tr("inventory.transferFailed", "Failed to transfer item", "转让物品失败");
tr("inventory.deleteConfirmTitle", "Delete \"{name}\"?", "删除 \"{name}\"?");
tr("inventory.deleteMsg", "This cannot be undone.", "此操作无法撤销。");
tr("inventory.deleteConfirm", "Delete item", "删除物品");
tr("inventory.deleteFailed", "Failed to delete item", "删除物品失败");
tr("inventory.buyConfirm", "Buy item", "购买物品");
tr("inventory.purchaseSuccess", "Item purchased successfully!", "物品购买成功!");
tr("inventory.purchaseFailed", "Failed to purchase item", "购买物品失败");
tr("inventory.nameRequired", "Item name is required", "物品名称必填");
tr("inventory.invalidJson", "Item data is not valid JSON", "物品数据不是有效的 JSON");
tr("inventory.createSuccess", "Item \"{name}\" created successfully!", "物品 \"{name}\" 创建成功!");
tr("inventory.createFailed", "Failed to create item", "创建物品失败");
tr("inventory.networkError", "Network error occurred", "发生网络错误");
tr("inventory.networkErrorCreate", "Network error \u2014 the item was not created", "网络错误 \u2014 物品未创建");
tr("inventory.copyLinkDone", "Link copied!", "链接已复制!");
tr("inventory.copyLinkFailed", "Couldn't copy link", "无法复制链接");
tr("inventory.sectionsAria", "Inventory sections", "库存分区");
tr("inventory.itemsCount", "{count} items", "{count} 件物品");
tr("inventory.itemsForSaleCount", "{count} items for sale", "{count} 件物品在售");
tr("inventory.newPriceAria", "New price for {name}", "{name} 的新价格");
tr("inventory.usernamePlaceholder", "Username", "用户名");
tr("inventory.transferAria", "Transfer {name} to username", "将 {name} 转让给用户名");
tr("inventory.copyLinkTitle", "Copy link to this item", "复制此物品的链接");
tr("inventory.copyLinkAria", "Copy link to {name}", "复制 {name} 的链接");
tr("inventory.historyCreated", "Created", "创建");
tr("inventory.historyTransferred", "Transferred from {from} to {to}", "从 {from} 转让给 {to}");
tr("inventory.historyPurchased", "Purchased by {to} for {price} credits", "由 {to} 以 {price} 积分购买");
tr("inventory.historyUnknown", "Unknown", "未知");
...
tr("me.completeCaptcha", "Complete the captcha", "请完成验证码");
...
tr("standing.warningAllowed", "Browsing, following, buying items, claiming daily credits, buying cosmetics, claiming gifts", "可浏览、关注、购买物品、领取每日积分、购买装扮、领取礼物");
tr("standing.warningRestricted", "Posting, replying, reposting, selling or transferring items, creating groups, sending friend requests, creating gifts", "发帖、回复、转发、出售或转让物品、创建群组、发送好友请求、创建礼物");
tr("standing.suspendedRestricted", "Posting, replying, following, buying or selling items, friend activity, gifting, cosmetics, groups, daily credits", "发帖、回复、关注、购买或出售物品、好友互动、礼物、装扮、群组、每日积分");
...
tr("tokens.loadError", "Something went wrong loading your tokens.", "加载令牌时出现问题。");
tr("tokens.networkError", "Network error — check your connection and try again.", "网络错误 — 请检查网络连接后重试。");
tr("tokens.networkErrorShort", "Network error", "网络错误");
tr("tokens.nameRequired", "Token name is required", "令牌名称必填");
tr("tokens.nameTooLong", "Name must be 50 characters or fewer", "名称不能超过 50 个字符");
tr("tokens.permRequired", "At least one permission is required", "至少需要一个权限");
tr("tokens.expiryNonNegative", "Expiry must be a non-negative number of hours", "有效期必须是非负数小时");
tr("tokens.expiryMax", "Maximum expiry is 1 year (8760 hours)", "最大有效期为 1 年 (8760 小时)");
tr("tokens.createFailed", "Failed to create token", "创建令牌失败");
tr("tokens.nameEmpty", "Name cannot be empty", "名称不能为空");
tr("tokens.nameUpdated", "Name updated", "名称已更新");
tr("tokens.renameFailed", "Failed to rename", "重命名失败");
tr("tokens.descUpdated", "Description updated", "描述已更新");
tr("tokens.descUpdateFailed", "Failed to update description", "更新描述失败");
tr("tokens.permsUpdated", "Permissions updated", "权限已更新");
tr("tokens.permsUpdateFailed", "Failed to update permissions", "更新权限失败");
tr("tokens.revoked", "Token revoked", "令牌已吊销");
tr("tokens.revokeFailed", "Failed to revoke", "吊销失败");
tr("tokens.deleteFailed", "Failed to delete", "删除失败");
tr("tokens.copyTokenPart1", "Copy this token now.", "请立即复制此令牌。");
tr("tokens.neverShownAgain", "It will never be shown again.", "它将不再显示。");
tr("tokens.copyTokenPart2", "Store it somewhere safe, you'll need to provide it to the app that requested it.", "请将其存放在安全的地方，您需要将它提供给请求的应用。");
tr("tokens.copy", "Copy", "复制");
tr("tokens.retry", "Retry", "重试");
tr("tokens.noTokensCreateHint", "Create one in the Create Token tab or grant scoped access from the /auth page.", "在“创建令牌”页面创建一个，或从 /auth 页面授予范围限定的访问权限。");
tr("tokens.permissionsLabel", "Permissions:", "权限:");
tr("tokens.createdLabel", "Created:", "创建时间:");
tr("tokens.nameLengthHint", "(1–50 chars)", "(1–50 个字符)");
tr("tokens.namePlaceholderExample", "e.g. \"My App, read-only\"", "例如 \"我的应用，只读\"");
tr("tokens.originApp", "Origin / App", "来源 / 应用");
tr("tokens.expiresInHours", "Expires in (hours)", "有效期 (小时)");
tr("tokens.expiresBlankNever", "(blank = never)", "(留空 = 永不过期)");
tr("tokens.expiresPlaceholder", "e.g. 720 for 30 days", "例如 720 表示 30 天");
tr("tokens.websites", "Websites", "网站");
tr("tokens.websitesHint", "(comma or space separated)", "(用逗号或空格分隔)");
tr("tokens.descriptionPlaceholder", "What is this token for?", "此令牌用于什么?");
tr("tokens.applyGroup", "Apply group…", "应用分组…");
tr("tokens.clearAll", "Clear all", "全部清除");
tr("tokens.searchPermissions", "Search permissions…", "搜索权限…");
tr("tokens.all", "All", "全部");
tr("tokens.none", "None", "无");
tr("tokens.forbidden", "forbidden", "禁止");
tr("tokens.permsSelected", "{count} permissions selected", "已选 {count} 个权限");
tr("tokens.pickAtLeastOne", "- pick at least one", "- 至少选择一个");
tr("tokens.cannotGranted", "cannot be granted", "无法授予");
tr("tokens.createSubToken", "Create Sub-Token", "创建子令牌");
tr("tokens.apiDocs", "Tokens API docs", "令牌 API 文档");
tr("tokens.tokenAriaLabel", "Token: {name}", "令牌: {name}");
tr("tokens.close", "Close", "关闭");
tr("tokens.subToken", "Sub-Token", "子令牌");
tr("tokens.permissionsCount", "{count} permissions", "{count} 个权限");
tr("tokens.expiredAt", "Expired at", "过期于");
tr("tokens.currentPermissions", "Current Permissions", "当前权限");
tr("tokens.editPermissions", "Edit Permissions", "编辑权限");
tr("tokens.modifyPermissions", "Modify Permissions", "修改权限");
tr("tokens.pickPermsForToken", "Pick the permissions for this token", "选择此令牌的权限");
tr("tokens.cancel", "Cancel", "取消");
tr("tokens.name", "Name", "名称");
tr("tokens.setNamePlaceholder", "Set token name", "设置令牌名称");
tr("tokens.update", "Update", "更新");
tr("tokens.revoke", "Revoke", "吊销");
tr("tokens.delete", "Delete", "删除");
...
tr("groups.searchError", "Something went wrong searching groups.", "搜索群组时出现问题。");
tr("groups.networkError", "Network error — check your connection and try again.", "网络错误 — 请检查网络连接后重试。");
tr("groups.networkErrorShort", "Network error", "网络错误");
tr("groups.policySaved", "Join policy and entry fee saved.", "加入方式和入场费已保存。");
tr("groups.failedSave", "Failed to save", "保存失败");
tr("groups.tagRequired", "Tag is required", "标签必填");
tr("groups.tagAlphanumeric", "Tag must be alphanumeric only", "标签只能包含字母和数字");
tr("groups.nameRequired", "Name is required", "名称必填");
...
tr("groups.createFailed", "Failed to create group", "创建群组失败");
tr("groups.imageTooLarge", "Image must be under 5MB", "图片必须小于 5MB");
...
tr("profile.networkErrorRetry", "Network error \u2014 please try again.", "网络错误 \u2014 请重试。");
tr("profile.couldntFollow", "Couldn't follow @{username}.", "无法关注 @{username}。");
tr("profile.couldntUnfollow", "Couldn't unfollow @{username}.", "无法取消关注 @{username}。");
tr("profile.couldntBlock", "Couldn't block @{username}.", "无法屏蔽 @{username}。");
tr("profile.couldntUnblock", "Couldn't unblock @{username}.", "无法取消屏蔽 @{username}。");
tr("profile.friendActionFailed", "Couldn't {action} @{username}.", "无法对 @{username} 执行 {action} 操作。");
tr("profile.verbAdd", "add", "添加");
tr("profile.verbRemove", "remove", "移除");
tr("profile.verbAccept", "accept", "接受");
tr("profile.verbReject", "reject", "拒绝");
tr("profile.noteSaveFailed", "Couldn't save your note.", "无法保存您的备注。");
tr("profile.noteNetworkError", "Network error \u2014 your note was not saved.", "网络错误 \u2014 备注未保存。");
...
tr("keys.networkErrorShort", "Network error", "网络错误");
tr("keys.setNamePlaceholder", "Set key name", "设置密钥名称");
tr("keys.creditsUnit", "credits", "积分");
tr("keys.keyAriaLabel", "Key: {name}", "密钥: {name}");
tr("keys.close", "Close", "关闭");
tr("keys.cancelledUntil", "Cancelled - access until {date}", "已取消 - 访问权限到 {date}");
tr("keys.nextBilling", "Next billing {date}", "下次计费 {date}");
...
tr("groups.tagChecking", "Checking\u2026", "检查中\u2026");
tr("groups.tagAvailable", "Tag is available", "标签可用");
tr("groups.tagInUse", "Tag already in use", "标签已被使用");
tr("groups.tagInvalid", "Invalid characters", "包含无效字符");
tr("groups.urlLabelPrefix", "URL:", "URL:");
tr("groups.tagInvalidHint", "Letters and numbers only \u00b7 ", "仅限字母和数字 \u00b7 ");
...
tr("groups.charactersCount", "{count} / 500 characters", "{count} / 500 个字符");
tr("groups.publicGroupLabel", "Public group", "公开群组");
tr("groups.publicGroupDesc", "Public groups appear in search. You can still choose how members join in the next steps.", "公开群组会出现在搜索结果中。您仍可在后续步骤中选择成员的加入方式。");
tr("groups.tagRequiredAlphanumeric", "Tag is required and must be alphanumeric.", "标签必填，且只能包含字母和数字。");
tr("groups.tagTakenError", "That tag is already in use.", "该标签已被使用。");
tr("groups.descriptionPlaceholder", "What is this group about?", "这个群组是关于什么的?");
...
tr("groups.reviewChargeLead", "Creating the group will charge 50 credits from your balance.", "创建群组将从您的余额中扣除 50 积分。");
tr("groups.brandingTitle", "Add some personality", "添加一些个性化内容");
tr("groups.brandingLead", "Both are optional. You can always update them from the group page later.", "两者均为可选。之后您随时可以在群组页面中更新。");
tr("groups.savingBtn", "Saving\u2026", "保存中\u2026");
tr("groups.feeChip", "{fee} cr fee", "{fee} 积分入场费");
tr("groups.openYourGroup", "Open your group", "打开群组");
tr("group.perm.groups.manage", "Manage Group", "管理群组");
tr("group.perm.groups.members.invite", "Invite Members", "邀请成员");
tr("group.perm.groups.members.remove", "Remove Members", "移除成员");
tr("group.perm.groups.members.ban", "Ban Members", "封禁成员");
tr("group.perm.groups.members.view", "View Members", "查看成员");
tr("group.perm.groups.roles.manage", "Manage Roles", "管理角色");
tr("group.perm.groups.roles.assign", "Assign Roles", "分配角色");
tr("group.perm.groups.announcements.send", "Send Announcements", "发送公告");
tr("group.perm.groups.events.manage", "Manage Events", "管理活动");
tr("group.perm.groups.events.publish", "Publish Events", "发布活动");
tr("group.perm.groups.tips.manage", "Manage Tips", "管理打赏");
tr("group.perm.groups.tips.withdraw", "Withdraw Tips", "提现打赏");
tr("group.perm.groups.tips.deposit", "Deposit Tips", "存入打赏");
tr("group.perm.groups.group.edit", "Edit Group", "编辑群组");
tr("group.policyOpen", "Open", "公开加入");
tr("group.policyRequest", "Request", "申请加入");
tr("group.policyInvite", "Invite Only", "仅邀请");
tr("group.notFound", "Group not found", "未找到群组");
tr("group.failedLoad", "Failed to load group", "加载群组失败");
tr("group.networkError", "Network error", "网络错误");
tr("group.joinRequestSent", "Join request sent.", "入群申请已发送。");
tr("group.requestFailed", "Failed to request access", "申请入群失败");
tr("group.joined", "Joined group!", "已加入群组!");
tr("group.joinFailed", "Failed to join", "加入群组失败");
tr("group.leaveConfirm", "Leave {name}?", "退出 {name}?");
tr("group.leaveMsg", "You'll lose your roles in this group.", "您将失去在此群组中的角色。");
tr("group.leaveBtn", "Leave group", "退出群组");
tr("group.left", "Left group.", "已退出群组。");
tr("group.leaveFailed", "Failed to leave", "退出失败");
tr("group.reportConfirm", "Report this group for review?", "举报此群组以供审核?");
tr("group.reportMsg", "A moderator will review this group.", "审核员将审核此群组。");
tr("group.reportBtn", "Report group", "举报群组");
tr("group.reportSent", "Report sent.", "举报已发送。");
tr("group.reportFailed", "Failed to report", "举报失败");
tr("group.nowShowing", "Now showing on profile.", "现在在资料页上展示。");
tr("group.showFailed", "Failed to show on profile", "展示到资料页失败");
tr("group.stoppedRepresenting", "Stopped representing group.", "已停止代表群组。");
tr("group.representFailed", "Failed", "操作失败");
tr("group.linkCopied", "Link copied!", "链接已复制!");
tr("group.imageTooLarge", "Image must be under 5MB.", "图片必须小于 5MB。");
tr("group.iconUpdated", "Icon updated.", "图标已更新。");
tr("group.bannerUpdated", "Banner updated.", "横幅已更新。");
tr("group.uploadFailed", "upload failed", "上传失败");
tr("group.loading", "Loading group\u2026", "加载群组中\u2026");
tr("group.backToGroups", "Back to Groups", "返回群组");
tr("group.notFoundTitle", "Group not found", "未找到群组");
tr("group.notFoundText", "The group you are looking for does not exist or is private.", "您查找的群组不存在或为私密群组。");
tr("group.tabOverview", "Overview", "概览");
tr("group.tabAnnouncements", "Announcements", "公告");
tr("group.tabMembers", "Members", "成员");
tr("group.tabRoles", "Roles", "角色");
tr("group.tabEvents", "Events", "活动");
tr("group.tabTips", "Tips", "打赏");
tr("group.tabAdmin", "Admin", "管理");
tr("group.updateBanner", "Update banner", "更新横幅");
tr("group.updateIcon", "Update icon", "更新图标");
tr("group.publicLabel", "Public", "公开");
tr("group.privateLabel", "Private", "私密");
tr("group.members", "members", "名成员");
tr("group.toJoin", "to join", "即可加入");
tr("group.balance", "balance", "余额");
tr("group.copyLink", "Copy Link", "复制链接");
tr("group.signInToJoin", "Sign in to Join", "登录后加入");
tr("group.joining", "Joining\u2026", "加入中\u2026");
tr("group.requestToJoin", "Request to Join", "申请加入");
tr("group.joinCredits", "Join ({price} credits)", "加入 ({price} 积分)");
tr("group.joinWithInvite", "Join with Invite", "凭邀请加入");
tr("group.joinGroupBtn", "Join Group", "加入群组");
tr("group.leave", "Leave", "退出");
tr("group.stopRepresenting", "Stop Representing", "停止代表");
tr("group.showOnProfile", "Show on profile", "在资料页展示");
tr("group.report", "Report", "举报");
tr("group.sectionsAria", "Group sections", "群组分区");
tr("group.groupUpdated", "Group updated.", "群组已更新。");
tr("group.tipSent", "Tip sent!", "打赏已发送!");
tr("group.joinRequestTitle", "Request to join", "申请加入");
tr("group.joinGroupTitle", "Join group", "加入群组");
tr("group.close", "Close", "关闭");
tr("group.groupRules", "Group rules", "群组规则");
tr("group.agreeToRules", "I have read and agree to these rules", "我已阅读并同意这些规则");
tr("group.joiningCosts", "Joining costs", "加入费用");
tr("group.deductedImmediately", "This is deducted immediately.", "此费用将立即扣除。");
tr("group.messageForAdmins", "Message for the admins (optional)", "给管理员留言 (可选)");
tr("group.whyDoYouWantToJoin", "Why do you want to join?", "您为什么想要加入?");
tr("group.working", "Working\u2026", "处理中\u2026");
tr("group.sendRequest", "Send request", "发送申请");
tr("group.joinForCredits", "Join for {price} credits", "以 {price} 积分加入");
tr("group.cancel", "Cancel", "取消");
tr("group.nameRequired", "Name is required", "名称必填");
tr("group.tagAlphanumeric", "Tag must be alphanumeric only", "标签只能包含字母和数字");
tr("group.tagMaxLength", "Tag must be 10 characters or less", "标签不能超过 10 个字符");
tr("group.entryFeeNonNegative", "Entry fee must be a non-negative number", "入场费必须是非负数");
tr("group.failedUpdate", "Failed to update", "更新失败");
tr("group.deleteConfirmTitle", "Delete \"{name}\"?", "删除 \"{name}\"?");
tr("group.deleteConfirmMsg", "This permanently removes the group and all of its data. This cannot be undone.", "这将永久删除群组及其所有数据。此操作无法撤销。");
tr("group.deleteBtn", "Delete group", "删除群组");
tr("group.failedDelete", "Failed to delete", "删除失败");
tr("group.yourRoles", "Your Roles", "您的角色");
tr("group.about", "About", "关于");
tr("group.aboutSub", "Group information and settings", "群组信息与设置");
tr("group.edit", "Edit", "编辑");
tr("group.delete", "Delete", "删除");
tr("group.nameLabel", "Name", "名称");
tr("group.tagLabel", "Tag", "标签");
tr("group.tagHint", "Alphanumeric only. Changing it updates the group URL.", "仅限字母和数字。修改后将更新群组 URL。");
tr("group.descriptionLabel", "Description", "描述");
tr("group.charCount", "{count} / 500 characters.", "{count} / 500 个字符。");
tr("group.readme", "Readme", "Readme");
tr("group.readmePlaceholder", "Long-form description. Supports markdown.", "长篇描述。支持 Markdown。");
tr("group.readmeCharCount", "{count} / 10,000 characters.", "{count} / 10,000 个字符。");
tr("group.rulesLabel", "Rules", "规则");
tr("group.rulesPlaceholder", "Shown before users join.", "用户加入前显示。");
tr("group.rulesCharCount", "{count} / 5,000 characters.", "{count} / 5,000 个字符。");
tr("group.entryFeeLabel", "Entry Fee (credits)", "入场费 (积分)");
tr("group.entryFeeHint", "Credits required to join. Set to 0 for free entry.", "加入所需的积分。设置为 0 表示免费加入。");
tr("group.publicGroup", "Public group", "公开群组");
tr("group.joinPolicy", "Join Policy", "加入方式");
tr("group.saving", "Saving\u2026", "保存中\u2026");
tr("group.saveChanges", "Save Changes", "保存更改");
tr("group.noDescription", "No description provided.", "未提供描述。");
tr("group.visibility", "Visibility", "可见性");
tr("group.entryFeeDisplay", "{fee} credits", "{fee} 积分");
tr("group.free", "Free", "免费");
tr("group.owner", "Owner", "所有者");
tr("group.membersLabel", "Members", "成员");
tr("group.creditBalance", "Credit Balance", "积分余额");
tr("group.readmeTitle", "Readme", "Readme");
tr("group.groupRulesTitle", "Group Rules", "群组规则");
tr("group.role", "role", "个角色");
tr("group.couldntLoadAnnouncements", "Couldn't load announcements.", "无法加载公告。");
tr("group.networkErrorAnnouncements", "Network error loading announcements.", "加载公告时网络错误。");
tr("group.titleRequired", "Title is required", "标题必填");
tr("group.announcementPosted", "Announcement posted!", "公告已发布!");
tr("group.failed", "Failed", "操作失败");
tr("group.deleteAnnouncement", "Delete this announcement?", "删除此公告?");
tr("group.announcementDeleted", "Announcement deleted.", "公告已删除。");
tr("group.unmuted", "Unmuted announcements.", "已取消静音公告。");
tr("group.mutedMsg", "Muted announcements.", "已静音公告。");
tr("group.notifications", "Notifications", "通知");
tr("group.mutedSub", "You will not receive announcements", "您不会收到公告");
tr("group.notMutedSub", "You receive announcements for this group", "您会收到此群组的公告");
tr("group.unmute", "Unmute", "取消静音");
tr("group.mute", "Mute", "静音");
tr("group.newAnnouncement", "New Announcement", "新公告");
tr("group.newAnnouncementSub", "Share an update with all members", "向所有成员分享更新");
tr("group.title", "Title", "标题");
tr("group.announcementTitlePlaceholder", "Announcement title", "公告标题");
tr("group.body", "Body", "正文");
tr("group.announcementBodyPlaceholder", "Write your announcement\u2026", "撰写您的公告\u2026");
tr("group.pingMembers", "Ping members with a notification", "通过通知提醒成员");
tr("group.posting", "Posting\u2026", "发布中\u2026");
tr("group.postAnnouncement", "Post Announcement", "发布公告");
tr("group.allAnnouncements", "All Announcements", "全部公告");
tr("group.totalCount", "{count} total", "共 {count} 条");
tr("group.loadingShort", "Loading\u2026", "加载中\u2026");
tr("group.noAnnouncements", "No announcements yet", "暂无公告");
tr("group.postFirstAnnouncement", "Post the first announcement above.", "请在上方发布第一条公告。");
tr("group.checkBackLater", "Check back later for updates.", "请稍后再来查看更新。");
tr("group.pingBadge", "Ping", "提醒");
tr("group.byUser", "by {user}", "由 {user}");
tr("group.couldntLoadMembers", "Couldn't load members.", "无法加载成员。");
tr("group.networkErrorConn", "Network error \u2014 check your connection and try again.", "网络错误 \u2014 请检查网络连接后重试。");
tr("group.notMember", "{user} is not a member of this group.", "{user} 不是此群组的成员。");
tr("group.foundRoles", "Found {count} role(s).", "找到 {count} 个角色。");
tr("group.lookupFailed", "Lookup failed", "查询失败");
tr("group.roleAssigned", "Role assigned.", "角色已分配。");
tr("group.removeRoleConfirm", "Remove this role from the user?", "从该用户移除此角色?");
tr("group.removeRoleBtn", "Remove role", "移除角色");
tr("group.roleRemoved", "Role removed.", "角色已移除。");
tr("group.yourMembership", "Your Membership", "您的成员身份");
tr("group.youAreMember", "You are a member", "您是成员");
tr("group.youAreNotMember", "You are not a member", "您不是成员");
tr("group.joinToSeeRoles", "Join this group to see your roles here.", "加入此群组以查看您的角色。");
tr("group.noRolesContact", "You have no roles assigned. Contact an owner.", "您没有分配任何角色。请联系群主。");
tr("group.member", "member", "名成员");
tr("group.searchMembersPlaceholder", "Search members\u2026", "搜索成员\u2026");
tr("group.searchMembersAria", "Search members", "搜索成员");
tr("group.search", "Search", "搜索");
tr("group.loadingMembers", "Loading members\u2026", "加载成员中\u2026");
tr("group.retry", "Retry", "重试");
tr("group.noMembersFound", "No members found.", "未找到成员。");
tr("group.membersTitle", "Members", "成员");
tr("group.editRoles", "Edit roles", "编辑角色");
tr("group.prev", "Prev", "上一页");
tr("group.pageOf", "Page {page} of {total}", "第 {page} 页，共 {total} 页");
tr("group.next", "Next", "下一页");
tr("group.manageMemberRoles", "Manage Member Roles", "管理成员角色");
tr("group.manageMemberRolesSub", "Look up a member by username to assign or remove roles", "通过用户名查找成员以分配或移除角色");
tr("group.usernamePlaceholder", "Username", "用户名");
tr("group.usernameLookupAria", "Username to look up roles for", "要查询角色的用户名");
tr("group.lookingUp", "Looking up\u2026", "查询中\u2026");
tr("group.lookup", "Lookup", "查询");
tr("group.rolesFor", "Roles for {user}", "{user} 的角色");
tr("group.remove", "Remove", "移除");
tr("group.availableToAssign", "Available to assign", "可分配的");
tr("group.assign", "Assign", "分配");
tr("group.editRolesTitle", "Edit Roles", "编辑角色");
tr("group.currentRoles", "Current roles", "当前角色");
tr("group.noRolesAssigned", "No roles assigned.", "未分配角色。");
tr("group.availableRoles", "Available roles", "可用角色");
tr("group.noRolesAvailable", "No roles available to assign.", "没有可分配的角色。");
tr("group.couldntLoadRoleShop", "Couldn't load roles for sale.", "无法加载出售中的角色。");
tr("group.networkErrorRoleShop", "Network error loading roles for sale.", "加载出售角色时网络错误。");
tr("group.nameRequiredShort", "Name required", "名称必填");
tr("group.benefitsFailed", "Role created but benefits failed: {err}", "角色已创建，但权益设置失败: {err}");
tr("group.roleCreated", "Role created.", "角色已创建。");
tr("group.roleUpdated", "Role updated.", "角色已更新。");
tr("group.deleteRoleConfirm", "Delete role \"{name}\"?", "删除角色 \"{name}\"?");
tr("group.deleteRoleMsg", "Members with this role will lose it.", "拥有此角色的成员将失去该角色。");
tr("group.deleteRoleBtn", "Delete role", "删除角色");
tr("group.roleDeleted", "Role deleted.", "角色已删除。");
tr("group.productNameRequired", "Product name required", "商品名称必填");
tr("group.chooseRoleToSell", "Choose a role to sell", "请选择要出售的角色");
tr("group.validPrice", "Enter a valid price", "请输入有效的价格");
tr("group.validFrequency", "Enter a valid billing frequency", "请输入有效的计费周期");
tr("group.roleProductCreated", "Role product created.", "角色商品已创建。");
tr("group.deleteProductConfirm", "Delete product \"{name}\"?", "删除商品 \"{name}\"?");
tr("group.deleteProductBtn", "Delete product", "删除商品");
tr("group.roleProductDeleted", "Role product deleted.", "角色商品已删除。");
tr("group.buyProductConfirm", "Buy {name}?", "购买 {name}?");
tr("group.buyProductMsg", "{price} credits will be deducted from your balance.", "将从您的余额中扣除 {price} 积分。");
tr("group.buyForCredits", "Buy for {price} credits", "以 {price} 积分购买");
tr("group.rolePurchased", "Role purchased.", "角色已购买。");
tr("group.newRole", "New Role", "新角色");
tr("group.newRoleSub", "Create a new role for members", "为成员创建新角色");
tr("group.assignOnJoin", "Assign on join", "加入时分配");
tr("group.selfAssign", "Members can self-assign this role", "成员可自行分配此角色");
tr("group.benefits", "Benefits", "权益");
tr("group.benefitsPlaceholder", "custom_color, priority_access", "custom_color, priority_access");
tr("group.benefitsHint", "Comma-separated benefit identifiers.", "以逗号分隔的权益标识。");
tr("group.createRole", "Create Role", "创建角色");
tr("group.roleShop", "Role Shop", "角色商店");
tr("group.roleShopSub", "Buy roles with credits or manage role products", "使用积分购买角色或管理角色商品");
tr("group.sellRole", "Sell Role", "出售角色");
tr("group.productName", "Product name", "商品名称");
tr("group.price", "Price", "价格");
tr("group.roleGranted", "Role granted", "授予角色");
tr("group.chooseRole", "Choose a role", "选择角色");
tr("group.recurringSubscription", "Recurring subscription", "定期订阅");
tr("group.frequency", "Frequency", "频率");
tr("group.period", "Period", "周期");
tr("group.day", "Day(s)", "天");
tr("group.week", "Week(s)", "周");
tr("group.month", "Month(s)", "月");
tr("group.year", "Year(s)", "年");
tr("group.createProduct", "Create Product", "创建商品");
tr("group.loadingRoleShop", "Loading role shop\u2026", "加载角色商店中\u2026");
tr("group.noPurchasableRoles", "No purchasable roles yet.", "暂无出售中的角色。");
tr("group.grantsRole", "Grants {role}", "授予 {role}");
tr("group.every", "every", "每");
tr("group.purchasing", "Purchasing\u2026", "购买中\u2026");
tr("group.buyRole", "Buy Role", "购买角色");
tr("group.allRoles", "All Roles", "全部角色");
tr("group.roleCount", "{count} role(s)", "{count} 个角色");
tr("group.noRolesDefined", "No roles defined yet.", "尚未定义角色。");
tr("group.permissions", "Permissions", "权限");
tr("group.save", "Save", "保存");
tr("group.onJoin", "on join", "加入时");
tr("group.selfAssignable", "self-assign", "自行分配");
tr("group.couldntLoadEvents", "Couldn't load events.", "无法加载活动。");
tr("group.networkErrorEvents", "Network error loading events.", "加载活动时网络错误。");
tr("group.validStartTime", "Valid start time is required", "需要有效的开始时间");
tr("group.noPublishPerm", "You don't have permission to publish events", "您没有发布活动的权限");
tr("group.eventCreated", "Event created!", "活动已创建!");
tr("group.eventPublished", "Event published.", "活动已发布。");
tr("group.eventDraft", "Event moved to draft.", "活动已转为草稿。");
tr("group.deleteEventConfirm", "Delete event \"{name}\"?", "删除活动 \"{name}\"?");
tr("group.deleteEventBtn", "Delete event", "删除活动");
tr("group.eventDeleted", "Event deleted.", "活动已删除。");
tr("group.newEvent", "New Event", "新活动");
tr("group.newEventSub", "Schedule an event for members", "为成员安排活动");
tr("group.startTime", "Start Time", "开始时间");
tr("group.durationHours", "Duration (hours)", "时长 (小时)");
tr("group.visibility", "Visibility", "可见性");
tr("group.membersOnly", "Members only", "仅成员");
tr("group.public", "Public", "公开");
tr("group.status", "Status", "状态");
tr("group.published", "Published", "已发布");
tr("group.creating", "Creating\u2026", "创建中\u2026");
tr("group.createEvent", "Create Event", "创建活动");
tr("group.events", "Events", "活动");
tr("group.eventCount", "{count} event(s)", "{count} 个活动");
tr("group.noEvents", "No events scheduled", "暂无安排的活动");
tr("group.createFirstEvent", "Create the first event above.", "请在上方创建第一个活动。");
tr("group.checkBackLaterShort", "Check back later.", "请稍后再来查看。");
tr("group.draft", "draft", "草稿");
tr("group.makeDraft", "Make Draft", "转为草稿");
tr("group.publish", "Publish", "发布");
tr("group.actionFailed", "Action failed", "操作失败");
tr("group.inviteSent", "Invite sent.", "邀请已发送。");
tr("group.joinReqAccepted", "Join request accepted.", "已接受入群申请。");
tr("group.joinReqDeclined", "Join request declined.", "已拒绝入群申请。");
tr("group.revokeInviteConfirm", "Revoke this invite?", "撤销此邀请?");
tr("group.revokeInviteBtn", "Revoke invite", "撤销邀请");
tr("group.inviteRevoked", "Invite revoked.", "邀请已撤销。");
tr("group.removeMemberConfirm", "Remove {user} from this group?", "将 {user} 移出此群组?");
tr("group.removeMemberMsg", "They can rejoin unless the group is invite-only.", "除非群组为仅邀请，否则他们可以重新加入。");
tr("group.removeMemberBtn", "Remove member", "移除成员");
tr("group.memberRemoved", "Member removed.", "成员已移除。");
tr("group.banConfirm", "Ban {user} from this group?", "封禁 {user} 出此群组?");
tr("group.banMsg", "They will not be able to rejoin.", "他们将无法重新加入。");
tr("group.banBtn", "Ban member", "封禁成员");
tr("group.memberBanned", "Member banned.", "成员已封禁。");
tr("group.memberUnbanned", "Member unbanned.", "成员已解封。");
tr("group.transferOwnerConfirm", "Transfer ownership to {user}?", "将所有权转让给 {user}?");
tr("group.transferOwnerMsg", "You will no longer be the owner of {group}. This cannot be undone.", "您将不再是 {group} 的所有者。此操作无法撤销。");
tr("group.transferOwnerBtn", "Transfer ownership", "转让所有权");
tr("group.ownershipTransferred", "Ownership transferred.", "所有权已转让。");
tr("group.validWithdrawAmount", "Enter a valid withdrawal amount", "请输入有效的提现金额");
tr("group.withdrawConfirm", "Withdraw {amount} credits?", "提现 {amount} 积分?");
tr("group.withdrawMsg", "This will be taken from the group balance and added to yours.", "此金额将从群组余额中扣除并转入您的余额。");
tr("group.withdrawBtn", "Withdraw", "提现");
tr("group.withdrawalComplete", "Withdrawal complete.", "提现完成。");
tr("group.invites", "Invites", "邀请");
tr("group.invitesSub", "Send and revoke pending invitations", "发送和撤销待处理邀请");
tr("group.usernameToInvite", "Username to invite", "要邀请的用户名");
tr("group.invite", "Invite", "邀请");
tr("group.noPendingInvites", "No pending invites.", "无待处理邀请。");
tr("group.invitedBy", "Invited by ", "由 ");
tr("group.revoke", "Revoke", "撤销");
tr("group.joinRequests", "Join Requests", "入群申请");
tr("group.joinRequestsSub", "Approve or decline requested access", "批准或拒绝申请");
tr("group.noPendingJoinRequests", "No pending join requests.", "无待处理的入群申请。");
tr("group.decline", "Decline", "拒绝");
tr("group.accept", "Accept", "接受");
tr("group.memberActions", "Member Actions", "成员操作");
tr("group.memberActionsSub", "Remove members, ban accounts, or transfer ownership", "移除成员、封禁帐号或转让所有权");
tr("group.refresh", "Refresh", "刷新");
tr("group.banReason", "Ban reason", "封禁原因");
tr("group.banReasonPlaceholder", "Optional reason used for the next ban", "可选，用于下次封禁的原因");
tr("group.noManageableMembers", "No manageable members found.", "未找到可管理的成员。");
tr("group.joinedPrefix", "Joined ", "加入于 ");
tr("group.transfer", "Transfer", "转让");
tr("group.bans", "Bans", "封禁");
tr("group.bansSub", "Review and remove group bans", "查看和移除群组封禁");
tr("group.noBans", "No bans.", "无封禁。");
tr("group.byPrefix", "By ", "由 ");
tr("group.unban", "Unban", "解封");
tr("group.tipJar", "Tip Jar", "打赏罐");
tr("group.tipJarSub", "Group balance: {balance} credits", "群组余额: {balance} 积分");
tr("group.location", "Location", "地点");
tr("group.withdrawing", "Withdrawing\u2026", "提现中\u2026");
tr("group.withdrawalAmount", "Amount to withdraw", "提现金额");
tr("group.noRecentWithdrawals", "No recent withdrawals.", "暂无最近提现。");
tr("group.couldntLoadTips", "Couldn't load tips.", "无法加载打赏记录。");
tr("group.networkErrorTips", "Network error loading tips.", "加载打赏记录时网络错误。");
tr("group.validAmount", "Enter a valid amount", "请输入有效的金额");
tr("group.sendTipConfirm", "Send {amount} credits to this group?", "向此群组发送 {amount} 积分?");
tr("group.sendTipBtn", "Send tip", "发送打赏");
tr("group.sentCredits", "Sent {amount} credits!", "已发送 {amount} 积分!");
tr("group.groupBalance", "Group Balance", "群组余额");
tr("group.groupBalanceSub", "Total tips received by this group", "此群组收到的打赏总额");
tr("group.sendTipTitle", "Send a Tip", "发送打赏");
tr("group.sendTipSub", "Support the group with credits", "使用积分支持此群组");
tr("group.amountInCredits", "Amount in credits", "金额 (积分)");
tr("group.tipAmountAria", "Tip amount in credits", "打赏金额 (积分)");
tr("group.sending", "Sending\u2026", "发送中\u2026");
tr("group.sendTip", "Send Tip", "发送打赏");
tr("group.note", "Note", "备注");
tr("group.notePlaceholder", "Optional message with your tip", "随打赏附带的留言 (可选)");
tr("group.noteCharCount", "{count} / 200 characters.", "{count} / 200 个字符。");
tr("group.yourBalance", "Your balance: {balance} credits", "您的余额: {balance} 积分");
tr("group.recentTips", "Recent Tips", "最近打赏");
tr("group.tip", "tip", "笔打赏");
tr("group.noTips", "No tips yet", "暂无打赏");
tr("group.beFirstTip", "Be the first to support the group!", "成为第一个支持此群组的人!");
tr("group.joinToTip", "Join the group to send a tip.", "加入群组以发送打赏。");
...
tr("transactions.filterIncome", "Income", "收入");
tr("transactions.filterExpense", "Expense", "支出");
tr("transactions.filterDaily", "Daily", "每日");
tr("transactions.filterTransfers", "Transfers", "转账");
tr("transactions.filterCosmetics", "Cosmetics", "装扮");
tr("transactions.filterKeys", "Keys", "密钥");
tr("transactions.filterGifts", "Gifts", "礼物");
tr("transactions.filterGroups", "Groups", "群组");
tr("transactions.incomeLegend", "Income", "收入");
tr("transactions.expenseLegend", "Expense", "支出");
tr("transactions.txCount", "{count} transactions", "{count} 笔交易");
tr("transactions.system", "system", "系统");
tr("confirmDialog.confirm", "Confirm", "确认");
tr("confirmDialog.cancel", "Cancel", "取消");
tr("link.failedHttp", "Link failed (HTTP {status}).", "链接失败 (HTTP {status})。");
tr("link.invalidCodeToken", "Invalid code or token. Try again.", "无效的验证码或令牌。请重试。");
tr("link.failed", "Link failed: {message}", "链接失败: {message}");
tr("link.codeCharAria", "Code char {index}", "验证码第 {index} 位");
tr("gift.notFound", "This gift could not be found.", "无法找到此礼物。");
tr("gift.networkError", "Could not reach Bilup Accounts. Try again later.", "无法连接到 Bilup Accounts。请稍后重试。");
tr("gift.claimFailed", "Could not claim this gift.", "无法领取此礼物。");
tr("perms.desc.account:delete", "Delete your account", "删除您的帐号");
tr("perms.desc.account:profile", "Edit your profile", "编辑您的资料");
tr("perms.desc.account:settings", "Change your account settings", "更改您的帐号设置");
tr("perms.desc.account:view", "View your profile", "查看您的资料");
tr("perms.desc.blocked:manage", "Manage your blocked users", "管理您屏蔽的用户");
tr("perms.desc.blocked:view", "See who you've blocked", "查看您屏蔽的用户");
tr("perms.desc.cosmetics:buy", "Buy cosmetics for you", "为您购买装扮");
tr("perms.desc.cosmetics:equip", "Equip cosmetics on your profile", "在您的资料上装备装扮");
tr("perms.desc.cosmetics:view", "View your cosmetics", "查看您的装扮");
tr("perms.desc.credits:daily", "Claim your daily credits", "领取您的每日积分");
tr("perms.desc.credits:manage", "Spend and manage your credits", "消费和管理您的积分");
tr("perms.desc.credits:transfer", "Transfer your credits", "转账您的积分");
tr("perms.desc.credits:view", "View your credit balance", "查看您的积分余额");
tr("perms.desc.files:delete", "Delete your files", "删除您的文件");
tr("perms.desc.files:manage", "Upload and manage your files", "上传和管理您的文件");
tr("perms.desc.files:view", "View your files", "查看您的文件");
tr("perms.desc.following:follow", "Follow people for you", "为您关注他人");
tr("perms.desc.following:unfollow", "Unfollow people for you", "为您取消关注他人");
tr("perms.desc.following:view", "See who you follow", "查看您关注的人");
tr("perms.desc.friends:accept", "Accept friend requests for you", "为您接受好友请求");
tr("perms.desc.friends:cancel", "Cancel your friend requests", "取消您的好友请求");
tr("perms.desc.friends:manage", "Manage your friends", "管理您的好友");
tr("perms.desc.friends:remove", "Remove your friends", "移除您的好友");
tr("perms.desc.friends:request", "Send friend requests for you", "为您发送好友请求");
tr("perms.desc.friends:view", "View your friends list", "查看您的好友列表");
tr("perms.desc.gifts:cancel", "Cancel your gifts", "取消您的礼物");
tr("perms.desc.gifts:claim", "Claim gifts for you", "为您领取礼物");
tr("perms.desc.gifts:create", "Create gifts on your behalf", "以您的名义创建礼物");
tr("perms.desc.gifts:view", "View your gifts", "查看您的礼物");
tr("perms.desc.groups:ban", "Ban members from your groups", "将成员移出您的群组");
tr("perms.desc.groups:invite", "Manage your group invites", "管理您的群组邀请");
tr("perms.desc.groups:join", "Join groups for you", "为您加入群组");
tr("perms.desc.groups:leave", "Leave groups for you", "为您退出群组");
tr("perms.desc.groups:manage", "Manage your groups", "管理您的群组");
tr("perms.desc.groups:members.view", "View members of your groups", "查看您群组的成员");
tr("perms.desc.groups:view", "View your groups", "查看您的群组");
tr("perms.desc.items:buy", "Buy marketplace items for you", "为您购买市场物品");
tr("perms.desc.items:manage", "Manage your marketplace items", "管理您的市场物品");
tr("perms.desc.items:sell", "Sell your marketplace items", "出售您的市场物品");
tr("perms.desc.items:view", "View marketplace items", "查看市场物品");
tr("perms.desc.keys:manage", "Manage your keys", "管理您的密钥");
tr("perms.desc.keys:view", "View your keys", "查看您的密钥");
tr("perms.desc.notifications:send", "Send notifications on your behalf", "以您的名义发送通知");
tr("perms.desc.notifications:view", "View your notifications", "查看您的通知");
tr("perms.desc.posts:create", "Create posts for you", "为您创建帖子");
tr("perms.desc.posts:delete", "Delete your posts", "删除您的帖子");
tr("perms.desc.posts:like", "Like posts for you", "为您点赞帖子");
tr("perms.desc.posts:manage", "Manage your posts", "管理您的帖子");
tr("perms.desc.posts:reply", "Reply to posts for you", "为您回复帖子");
tr("perms.desc.posts:repost", "Repost for you", "为您转发");
tr("perms.desc.posts:view", "View posts", "查看帖子");
tr("perms.desc.tokens:manage", "Manage your access tokens", "管理您的访问令牌");
tr("perms.desc.validators:generate", "Generate validators for you", "为您生成验证器");
