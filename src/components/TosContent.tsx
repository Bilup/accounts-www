  ...
  return (
    <>
      ...
      <p>
        ...
        participate in a vibrant, interconnected ecosystem.
      </p>
      ...
      <ul>
        <li>
          <strong>Account Management:</strong> Centralized user accounts with
          customizable profiles, themes, and personal settings
        </li>
        <li>
          <strong>Authentication Services:</strong> Single sign-on (SSO)
          capabilities for integrated services and third-party applications
        </li>
        <li>
          <strong>File Storage:</strong> Personal file storage and management
          capabilities
        </li>
      </ul>
      ...
      <ul>
        <li>
          The service is provided on a best-effort basis with no guaranteed
        ...
        <li>
          Storage capacity and bandwidth may be subject to reasonable limits to
          ensure fair usage.
        </li>
        <li>
          Third-party integrations may be discontinued or modified based on
          external factors.
        </li>
        <li>
        ...
        <li>
          Support is provided by a small team and response times may vary.
        </li>
        <li>
          Data backup and recovery capabilities may be limited; users are
          responsible for maintaining their own backups of important content.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          Use an identity that does not impersonate others or intentionally
          mislead, defraud, or harm.
        </li>
        <li>
          ...
          <ul>
            ...
            <li>
              Promptly reporting any suspected unauthorized access or security
              breaches
            </li>
      ...
      <p>
        Examples of prohibited account activity include, but are not limited to:
        creating multiple accounts to evade bans, using scripts to exploit or
        scrape ("Web scraping, web harvesting, or web data extraction") content
        from the service, or providing false information during registration.
      </p>
      <p>
      ...
      <ul>
        ...
        <li>
          User-specific customization data (e.g. themes, wallpapers, banners)
        </li>
        <li>Transactional or activity history associated with the account</li>
      </ul>
      <p>
      ...
      <p>
        ...
        <ul>
          <li>
            Account data: Retained until account deletion is complete, plus 30
            days for data recovery
          </li>
          <li>
            Content and uploads: Deleted within 14 days of account deletion
            request
          </li>
          <li>
            IP addresses and logs: Retained for a maximum of 90 days unless
            required for active investigations or legal proceedings
          </li>
          <li>
            Transactional history: Retained for 5 years to comply with financial
      ...
      <p>
        ...
        <ul>
          <li>
            <strong>Contract:</strong> Processing is necessary to provide you
            with our services and fulfill our contractual obligations to you.
          </li>
          <li>
            <strong>Legitimate Interests:</strong> We may process data for
            security, moderation, fraud prevention, and service improvement,
      ...
      <p>
        ...
        functionality. For more details, see our Privacy Policy.
      </p>
      ...
      <p>
        Users may upload files and customize their profile. The following are
        strictly prohibited:
      </p>
      <ul>
        <li>
          Illegal content or copyrighted material without permission (e.g.,
          pirated software, unlicensed media)
        </li>
        <li>
        ...
        <li>
          Spam, scams, or fraudulent activity (e.g., pyramid schemes, phishing
          attempts, fake giveaways)
        </li>
        <li>
      ...
      <p>
        <strong>NSFW (Not Safe For Work) content is strictly prohibited</strong>{" "}
      ...
      <ul>
        <li>
          <strong>Nudity:</strong> Any depiction of exposed genitals, female
          nipples, or buttocks, regardless of artistic intent
        </li>
        <li>
          <strong>Sexual Acts:</strong> Any visual depiction, illustration, or
          description of sexual activity, including but not limited to:
          <ul>
        ...
        <li>
          <strong>Sexually Suggestive Content:</strong> Content that implies or
          suggests sexual activity, including:
          <ul>
            <li>Poses that emphasize or draw attention to sexual body parts</li>
            <li>
              Clothing or lack thereof intended to be sexually arousing
              (lingerie modeled in suggestive poses, swimwear in non-beach/pool
              contexts with suggestive posing)
            </li>
            <li>
              Text, usernames, or descriptions with sexual innuendo or explicit
              sexual references
            </li>
            <li>
              "Ahegao" faces or expressions designed to simulate sexual arousal
            </li>
          </ul>
        </li>
        <li>
          <strong>Fetish Material:</strong> Any content depicting or catering to
          sexual fetishes, including but not limited to:
          <ul>
            <li>BDSM equipment, scenarios, or roleplay</li>
            <li>Foot fetish content (sexualized depictions of feet)</li>
            <li>Any content sexualizing non-sexual objects or scenarios</li>
          </ul>
        </li>
      </ul>
      ...
      <ul>
        <li>
          <strong>Graphic Violence:</strong> Real or realistic depictions of:
          <ul>
            <li>Severe injury with visible blood, wounds, or bodily harm</li>
        ...
        <li>
          ...
          <ul>
            <li>Internal organs, exposed bone, or severe tissue damage</li>
            <li>Excessive blood or bodily fluids in violent contexts</li>
      ...
      <div className="info-box">
        <strong>Exception:</strong> Stylized cartoon violence (e.g., typical
        video game violence) without realistic gore is permitted.
      </div>
      ...
      <ul>
        <li>
          ...
          <ul>
            ...
            <li>
              Content that could be construed as sexualizing minors in any way
            </li>
          </ul>
        </li>
      </ul>
      ...
      <ul>
        <li>
          Content is subject to automated scanning for prohibited material
        </li>
        <li>Flagged content is automatically hidden pending manual review</li>
        <li>Users will be notified when content is flagged for review</li>
      </ul>
      ...
      <ul>
        <li>
          <strong>Context Consideration:</strong> Artistic, educational, or news
          context does not exempt content from NSFW rules
        </li>
        <li>
        ...
        <li>
          <strong>Community Standards:</strong> Content must be appropriate for
          a general audience including 13+ users
        </li>
        <li>
          <strong>Borderline Content:</strong> When in doubt, content will be
          classified as NSFW and removed
        </li>
      </ul>

      <div className="warning-box">
        <strong>Important:</strong> Artistic, educational, or news context does
        NOT exempt content from NSFW rules. Content is judged solely by its
        appearance and appropriateness for all users.
      </div>
      ...
      <ol>
        <li>
          <strong>Initial Appeal:</strong> Submit appeal within 7 days of
          removal notice via support channels
        </li>
        <li>
          <strong>Review Timeline:</strong> Appeals are reviewed within 5
          business days
        </li>
        <li>
          <strong>Appeal Decision:</strong> Final decision communicated with
          specific reasoning
        </li>
        <li>
          <strong>Escalation:</strong> Decisions may be escalated to Platform
          Owner for final review
        </li>
        <li>
          <strong>False Claims:</strong> Repeated frivolous appeals may result
      ...
      <p>
        ...
        violations involving immediate account termination, appeals are limited
        to factual errors in the decision. Good faith disputes about
        classification may be reviewed at our discretion, but decisions are not
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <br />• Mandatory acknowledgment of guidelines before restoration
            </td>
          ...
          <tr>
            ...
            <td>
              No appeals process for termination decisions; factual error
      ...
      <div className="danger-box">
        <strong>Severe Violations – Immediate Account Termination:</strong>
        <ul>
      ...
      <ul>
        ...
        <li>
          <strong>Emergency Reports:</strong> For illegal content, contact
          authorities and notify us immediately
        </li>
      </ul>

      <div className="info-box">
        <strong>Reporter Protection:</strong> Users reporting in good faith are
        protected from retaliation. False reporting for harassment purposes will
        result in penalties for the reporting user.
      </div>
      ...
      <ul>
        <li>Review all content before uploading to ensure compliance</li>
        <li>Understand that "accidental" violations are still violations</li>
        <li>Take responsibility for content shared through their accounts</li>
        <li>
          Monitor content shared by others using their integrations or services
        </li>
      </ul>
      <p>
        <strong>Accountability:</strong> Claiming ignorance of these guidelines,
        technical errors, or third-party responsibility does not exempt users
        from enforcement actions. However, users retain all legal rights and
        protections afforded under applicable law, including the right to pursue
        legal remedies for wrongful content removal.
      </p>
      ...
      <p>
        ...
        prohibited content or clarify existing definitions. Users will be
        notified of significant changes and given reasonable time to comply with
        updated standards.
      </p>
      ...
      <ul>
        <li>
          Account creation and basic platform access are provided at no cost
        </li>
        <li>
          Core features including authentication, file storage (within limits),
          and integrated services are free to use
        </li>
        <li>
          Premium features and services may require credits or direct payment
        </li>
        <li>
          No credit card or payment information is required for standard account
          registration
        </li>
      </ul>
      ...
      <ul>
        <li>
          <strong>Billing Practices:</strong> All charges are clearly disclosed
          before purchase, with transparent pricing and billing cycles
        </li>
        <li>
          <strong>Payment Processing:</strong> Payments are processed through
          secure third-party providers with industry-standard security measures
        </li>
        <li>
          <strong>Refund Policy:</strong> Refund eligibility is determined on a
          case-by-case basis, with consideration for service availability and
          user satisfaction
        </li>
        <li>
          <strong>Subscription Terms:</strong> Any recurring charges require
          explicit user consent and include clear cancellation procedures
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          Credits may be earned through platform activities and participation
        </li>
        <li>
          Credits may expire or be subject to terms of use specific to their
          intended purpose
        </li>
        <li>
        ...
        <li>
          Users may not use bots, scripts, automated tools, or any form of
          artificial intelligence to earn credits or participate in
          credit-generating activities. All credit earning must be through
          genuine human interaction and participation.
        </li>
        <li>
          Misuse of credits, including fraudulent acquisition, exploitation of
          system vulnerabilities, unauthorized generation, or violations of
        ...
        <li>
          Credit transactions and balances are subject to platform monitoring
      ...
      <ul>
        ...
        <li>
          Attempt to manipulate, exploit, or abuse any payment or credit systems
        </li>
        <li>
          Engage in money laundering, fraud, or other financial crimes through
          the platform
        </li>
        <li>
          Create multiple accounts to circumvent payment limitations or obtain
      ...
      <ul>
        ...
        <li>
          Discontinue free services or features if necessary for platform
          sustainability
        </li>
        <li>
          Update pricing, billing terms, or payment policies with advance
          notification
        </li>
      </ul>
      <p>
        Significant changes to the service model will be communicated to users
      ...
      <ul>
        <li>
          Suspend, restrict, or terminate any account for any reason, including
          but not limited to violation of these Terms, suspected fraud, or
          security concerns
        </li>
      ...
      <ul>
        <li>
          Store, display, and distribute user content as necessary to provide
          the service
        </li>
        <li>
        ...
        <li>
          Allow other users to view and interact with content according to the
          user's privacy settings
        </li>
      </ul>
      <p>
        This license terminates when content is deleted from the platform,
        except for content that has been shared with or cached by other users or
        services.
      </p>
      ...
      <p>
        ...
        or inability to use the service; (b) any unauthorized access to or use
        of our servers and/or any personal information stored therein; (c) any
        ...
        or through our service by any third party; or (e) any errors or
      ...
      <p>
        ...
        use of and access to the service; (b) your violation of any term of
        these Terms; (c) your violation of any third-party right, including
        without limitation any copyright, property, or privacy right; or (d) any
      ...
      <ul>
        ...
        <li>
          ...
          agreement to the new provisions
        </li>
      </ul>
      <p>
        Users are responsible for reviewing the most current version of these
        Terms and understanding any changes that may affect their use of the
        service.
      </p>
      ...
      <p>
        ...
        actions, or interruptions in internet services.
      </p>
      ...
      <p>
        ...
        obligated to implement any suggestions or respond to every submission.
      </p>
      ...
      <p>
        ...
        loss, instability, or incompatibility. We encourage users to provide
        feedback on these features to help us improve the platform.
      </p>
      ...
      <ul>
        <li>
          These Terms of Service in full, including all content guidelines and
          prohibited conduct rules
        </li>
        <li>
          Any additional API-specific terms or usage policies we may publish
        </li>
        <li>
          Rate limiting and usage restrictions as communicated through our
          developer documentation
        </li>
        <li>
          The requirement that third-party applications do not facilitate
          violations of these Terms
        </li>
      </ul>
      <p>
        API access may be revoked at any time without notice if usage is deemed
        abusive, excessive, or in violation of these Terms. We reserve the right
        to introduce or modify API pricing, rate limits, or access requirements
        at any time.
      </p>
      <p>
        Developers are responsible for ensuring their applications comply with
        applicable laws and regulations in the jurisdictions where their users
        are located.
      </p>
      ...
      <p style="font-size: 0.9em; color: var(--text-muted);">
        <em>
          We aim to respond to all inquiries within 3-5 business days. For
          urgent security concerns, please include "Security" in your subject
          line for faster handling.
        </em>
      </p>
    </>
  );
