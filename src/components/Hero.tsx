import { ArrowRight, ArrowDown } from "lucide-preact";
  ...
  return (
    <section class={s.hero}>
      ...
      <div class={s.content}>
        ...
        <p class={s.sub}>
          Rotur is an ecosystem provider that enables seamless cross-platform
          communication, social features, and cloud storage - all wired
          together.
        </p>
